...
import { FaPhoneAlt, FaHospitalAlt, FaMapMarkerAlt, FaExclamationTriangle } from "react-icons/fa";
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <h1 style={{ color: '#d32f2f', marginBottom: 16 }}>Hiến máu khẩn cấp</h1>
        <p style={{ fontSize: 18, marginBottom: 18 }}>
          Nếu bạn hoặc người thân cần máu khẩn cấp, vui lòng liên hệ ngay với các số điện thoại sau:
        </p>
        <div style={{
          background: '#fff3e0',
          borderRadius: 12,
        ...
        <div style={{ marginBottom: 18 }}>
          <FaHospitalAlt style={{ color: '#388e3c', fontSize: 22, marginRight: 8 }} />
          <span>Hoặc đến trực tiếp các điểm hiến máu gần nhất để được hỗ trợ nhanh chóng.</span>
        </div>
        <div style={{ margin: '18px 0', textAlign: 'left', color: '#174c8f', fontSize: 16 }}>
          <b>Địa chỉ các điểm hiến máu lớn tại TP.HCM:</b>
        ...
        <div style={{ marginTop: 24, color: '#888', fontSize: 15 }}>
          ...
          Hotline tổng đài: 1900 1234
        </div>
        <div style={{ marginTop: 18, color: '#388e3c', fontSize: 15 }}>
          <b>Hướng dẫn:</b> Mang theo giấy tờ tùy thân, tuân thủ hướng dẫn của nhân viên y tế khi đến điểm hiến máu.
        </div>
      </div>
      <Footer />
    </>
